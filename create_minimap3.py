    ...
    while(cap.isOpened()):
        ...
        if ret:
            ...
            if frame_num % 2 == 0:
                ...
                warped_image_high_res = transform_image(M, main_frame, (540, 960))
                warped_image_high_res_path = os.path.join(warped_images_path, f"frame_{frame_num:06d}_high_res.jpg")
